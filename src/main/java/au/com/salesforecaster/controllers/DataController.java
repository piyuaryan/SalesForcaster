package au.com.salesforecaster.controllers;

import au.com.salesforecaster.model.WeeklyProfit;
import au.com.salesforecaster.service.DataService;
...
//            json.put("status", AppUtils.SUCCESS);
    ...
    public ResponseEntity<String> getWeatherInfo() throws Exception {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
        JSONObject json = new JSONObject();
        try {
            String result = dataService.getWeatherInfo();
    ...
    @RequestMapping(value = "/getSalesData/{pageSize}/{page}")
    public
    @ResponseBody
    List<Map<String, Object>> getSalesData(@PathVariable String pageSize, @PathVariable String page) {
